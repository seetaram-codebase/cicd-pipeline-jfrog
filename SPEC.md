...
|---|---|---|
| `feature/*` (and anything else) | `artifact-sandbox` | No — stops after the scan gate |
| `develop`, `master` | `artifact-release` | Yes — automatically, if the scan passes |
...
5. Create the 2 Docker repos (`artifact-sandbox`, `artifact-release`),
